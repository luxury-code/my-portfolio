 ...
 * About 섹션의 이야기 한 토막. 번호 · 소제목 · 큰 인용구 · 본문으로 이뤄진다.
 ...
 *
 * Example usage:
 * <AboutStoryBlock index="01" title="시작" lead="..." paragraphs={ ['...'] } />
 */
function AboutStoryBlock({ index, title, lead, paragraphs = [], tags = [], isLast = false }) {
  return (
    <Box
      component="article"
      sx={ {
